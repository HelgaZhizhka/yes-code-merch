      ...
      <div className="flex flex-col gap-6 max-w-lg p-8 w-full text-center">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gray-600">
            If you&apos;ve just registered, we&apos;ve sent a verification link
            to your email. Please check your inbox and click the link to
          ...
          <div className="mt-4 p-4 bg-orange-50 rounded-lg">
            <p className="text-sm text-orange-800">
              💡 <strong>Tip:</strong> Can&apos;t find the email? Check your
              spam folder or try registering again with the same email address.
            </p>
          </div>
          <div className="mt-6">
